...
import com.ABCcompany.employeesGroup.json.pojo.EmployeePojo;
...
public class EmployeePojo {
	...
	public EmployeePojo withId(Integer id) {
		this.id = id;
		return this;
	}
	...
	public EmployeePojo withFirstName(String firstName) {
		this.firstName = firstName;
		return this;
	}
	@JsonProperty("lastName")
	...
	public EmployeePojo withLasttName(String lastName) {
		this.lastName = lastName;
		return this;
	}
	...
	public EmployeePojo withEmail(String email) {
		this.email = email;
		return this;
	}
	...
	public EmployeePojo withMarritalStatus(String marritalStatus) {
		this.marritalStatus = marritalStatus;
		return this;
	}
	...
	public EmployeePojo withSalary(Integer salary) {
		this.salary = salary;
		return this;
	}
	...
	public String toString() {
		...
		sb.append(EmployeePojo .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
		sb.append("id");
		sb.append('=');
